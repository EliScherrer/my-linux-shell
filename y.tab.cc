...
{
  "$end", "error", "$undefined", "WORD", "QUOTES", "NOTOKEN", "GREAT",
  "NEWLINE", "LESS", "GREATGREAT", "AMPERSAND", "PIPE", "ERRR",
  "GREATAMPERSAND", "GREATGREATAMPERSAND", "$accept", "goal",
  "command_list", "command_line", "command_and_args", "argument_list",
  "argument", "command_word", "io_modifier", "io_modifier_list",
  "pipe_list", "background", YY_NULLPTR
};
#endif
...
{
      10,    -2,    -7,    -7,     1,     9,    -7,    -7,    -7,     7,
      -7,    -7,    -7,    11,    16,    -6,    -7,    -7,    -7,    -7,
      17,    18,    19,    -7,    20,    21,    22,    -7,    23,    -7,
      -7,    -7,    -7,    -7,    -7,    -7
};
...
{
       0,     0,    13,     6,     0,     0,     3,    23,    10,    21,
       7,     1,     4,     8,     0,    25,    11,    12,     9,    22,
       0,     0,     0,    24,     0,     0,     0,    20,     0,    14,
      15,    16,    19,    17,    18,     5
};
...
{
      20,    11,    21,    22,    23,    10,    24,    25,    26,    -2,
       1,     1,     2,     2,    16,    17,     3,     3,    14,     2,
      29,    30,    31,    32,    33,    34,    19,     0,     0,    12,
      35
};

static const yytype_int8 yycheck[] =
{
       6,     0,     8,     9,    10,     7,    12,    13,    14,     0,
       1,     1,     3,     3,     3,     4,     7,     7,    11,     3,
       3,     3,     3,     3,     3,     3,    14,    -1,    -1,     5,
       7
};
...
{
       0,     1,     3,     7,    16,    17,    18,    19,    22,    25,
       7,     0,    18,    20,    11,    24,     3,     4,    21,    19,
       6,     8,     9,    10,    12,    13,    14,    23,    26,     3,
       3,     3,     3,     3,     3,     7
};
